...
export const serviceCategories: ServiceCategory[] = [
  ...
  // 6. الخدمات الجامعية
  {
    ...
    services: [
      ...
      { name: { ar: "دفع حقوق إعادة التسجيل", en: "Re-registration Fee Payment" }, url: "https://progres.mesrs.dz/epaiement" },
      { name: { ar: "دفع حقوق الإيواء", en: "Accommodation Fee Payment" }, url: "https://progres.mesrs.dz/epaiement/login.xhtml" },
      { name: { ar: "طلبات الإيواء", en: "Accommodation Requests" }, url: "https://progres.mesrs.dz/webetu/login.xhtml" },
      { name: { ar: "التحويلات الجامعية", en: "University Transfers" }, url: "https://progres.mesrs.dz/webetu/login.xhtml" },
