...
exports.serviceCategories = [
    ...
    // 27. الأمن الوطني
    {
        ...
        services: [
            ...
            { name: { ar: "بحث في فائدة العائلات", en: "Family Search" }, url: "https://www.dgsn.dz" },
            { name: { ar: "الدليل الهاتفي", en: "Phone Directory" }, url: "https://annuaire.dgsn.dz" },
            { name: { ar: "تطبيق ألو الشرطة", en: "Allo Police App" }, url: "https://play.google.com/store/apps/details?id=allochorta.algeriepolice.dz", isApp: true },
        ],
    },
