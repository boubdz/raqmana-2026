          ...
          <div className="rounded-3xl border border-border/60 bg-card p-8 md:p-12 shadow-sm space-y-10">
            ...
            <section className="space-y-4 border-t border-border/60 pt-8">
              <h2 className="text-2xl font-black text-foreground flex items-center gap-3">
                ...
                <span>3. استخدام الأدوات التفاعلية والمحاكيات</span>
              </h2>
              <p className="text-muted-foreground leading-relaxed text-base">
                تُقدم الأدوات المتوفرة على الموقع (كحاسبة رواتب الوظيف العمومي، محاكي أقساط عدل 3، حاسبة سونلغاز، وصانع السيرة الذاتية) لأغراض الاسترشاد والمحاكاة التقديرية فقط:
              </p>
              <ul className="space-y-2 list-disc pr-6 text-muted-foreground text-base">
                <li>المبالغ والأرقام الناتجة عن هذه الأدوات هي نتائج تقريبية مستندة إلى النصوص القانونية والمراسيم التنفيذية المعلنة، ولا تعوض كشوف الرواتب أو الفواتير أو القرارات الصادرة رسمياً عن الإدارات المختصة.</li>
                <li>يتحمل المستخدم وحده مسؤولية تدقيق ومطابقة أي بيانات قبل الشروع في إجراءات رسمية أو تعاملات مالية.</li>
              </ul>
            </section>
