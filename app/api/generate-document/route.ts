  ...
  try {
    ...
    if (openrouterApiKey) {
      ...
      const systemPrompt = isCv
        ? `أنت خبير إعداد وكتابة السير الذاتية (CV / Resume) الاحترافية الموجهة للتوظيف والمسابقات في الجزائر.
        قم بصياغة سيرة ذاتية منظمة وجذابة ودقيقة باللغة العربية بالهيكل التالي:
        1. [البيانات الشخصية]: الاسم واللقب، تاريخ ومكان الميلاد، العنوان والولاية، رقم الهاتف، البريد الإلكتروني، الوضعية تجاه الخدمة الوطنية (للذكور).
        2. [الهدف المهني]: فقرة موجزة من سطرين تبرز الحافز والشغف بالمنصب المستهدف.
        3. [المؤهلات العلمية والشهادات]: مرتبة من الأحدث إلى الأقدم مع ذكر التخصص والمؤسسة الجامعية/المعهد وسنة التخرج.
        4. [الخبرات المهنية والتربصات]: المهام والمسؤوليات والإنجازات.
        5. [المهارات والكفاءات]: المهارات التقنية والمهنية وبرامج الإعلام الآلي.
        6. [اللغات]: مستوى الإتقان (العربية، الفرنسية، الإنجليزية).
        اكتب السيرة الذاتية بتنسيق رصين ومباشر بدون تعليقات خارجية أو مقدمات.`
        : `أنت مساعد كتابة النماذج الإدارية الجزائرية الرسمية.
