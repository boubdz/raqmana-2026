...
export async function GET() {
  ...
  const pages = [
    ...
    { loc: `${baseUrl}/privacy-policy`, lastmod: now, changefreq: 'monthly', priority: '0.7' },
    { loc: `${baseUrl}/terms-of-service`, lastmod: now, changefreq: 'monthly', priority: '0.7' },
    { loc: `${baseUrl}/disclaimer`, lastmod: now, changefreq: 'monthly', priority: '0.7' },
    { loc: `${baseUrl}/sitemap`, lastmod: now, changefreq: 'weekly', priority: '0.6' },
