...
export const metadata: Metadata = {
  title: {
    default: 'الموسوعة الجزائرية للخدمات الرقمية 2026 | منحة البطالة، بروغرس، بريدي موب، عدل 3',
    template: '%s | رقمنة'
  },
  description: 'الموسوعة الجزائرية للخدمات الرقمية (رقمنة 2026): روابط مباشرة لمنصة منحة البطالة ANEM، بريدي موب، بروغرس، سكنات عدل 3، استخراج S12، ودفع فاتورة سونلغاز. دليل شامل ومجاني.',
  generator: 'Raqmana',
  ...
  keywords: [
    ...
    'الموسوعة الجزائرية للخدمات الرقمية', 'البوابة الجزائرية للخدمات الرقمية', 'رقمنة الجزائر', 'رقمنة الجزائر 2026', 'رقمنة 2026', 'البوابة الرقمية الجزائرية', 'الخدمات الرقمية في الجزائر',
  ...
  openGraph: {
    title: 'الموسوعة الجزائرية للخدمات الرقمية 2026 | منحة البطالة، بروغرس، بريدي موب، عدل 3',
    description: 'الموسوعة الجزائرية للخدمات الرقمية (رقمنة 2026): روابط مباشرة لمنصة منحة البطالة ANEM، بريدي موب، بروغرس، سكنات عدل 3، استخراج S12، ودفع فاتورة سونلغاز. دليل شامل ومجاني.',
    url: 'https://www.raqmanadz.com',
    siteName: 'الموسوعة الجزائرية للخدمات الرقمية',
    locale: 'ar_DZ',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'الموسوعة الجزائرية للخدمات الرقمية 2026 - رقمنة',
      },
    ],
  },
  twitter: {
  ...
  return (
    <html lang="ar" dir="rtl" suppressHydrationWarning>
      <head>
        ...
        />
        {/* Google AdSense Official Verification & Ad Loader */}
