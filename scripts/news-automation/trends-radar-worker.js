...
async function generateTrendArticleWithGemini(trendItem, matchedOfficial) {
  const isFromAPS = trendItem.isTier1Official === true;

  // تعليمات إضافية خاصة بأخبار وكالة الأنباء الجزائرية الرسمية (APS)
  const apsExtraInstruction = isFromAPS ? `
[تعليمات خاصة — المصدر: وكالة الأنباء الجزائرية الرسمية (APS)]:
أنت كاتب محتوى إداري جزائري موجه للمواطن العادي. الخبر الرسمي من APS مكتوب بلغة رسمية جافة.
عليك القيام بما يلي:
- إعادة الصياغة بلغة مبسطة ومباشرة يفهمها المواطن الجزائري دون خبرة قانونية أو إدارية.
- إضافة الشرح الكافي: ما معنى هذا القرار؟ من يستفيد منه؟ ما التأثير المباشر على المواطن والأسرة؟
- إضافة الخطوات العملية والإجراءات والشروط التي يحتاجها المواطن (استنبطها من طبيعة القطاع والجهة المختصة).
- الحفاظ الحرفي على الأرقام والتواريخ والمعطيات الرسمية كما وردت في خبر APS دون أي تعديل أو تقريب.
- الاقتباس الحرفي لعبارة أساسية من الخبر مع ذكر المصدر: وكالة الأنباء الجزائرية الرسمية (APS).
` : '';

  const systemRole = isFromAPS
    ? 'أنت كاتب محتوى إداري جزائري متخصص في تحويل الأخبار الرسمية إلى دليل عملي ومبسط للمواطن.'
