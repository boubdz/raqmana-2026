...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/articles/employment', destination: '/categories/employment', permanent: true },
      { source: '/articles/bills', destination: '/categories/bills', permanent: true },
      { source: '/articles/mobile', destination: '/categories/mobile', permanent: true },
      { source: '/articles/tax', destination: '/categories/tax', permanent: true },
      { source: '/articles/post', destination: '/categories/post', permanent: true },
      { source: '/articles/telecom', destination: '/categories/telecom', permanent: true },
      { source: '/articles/education', destination: '/categories/education', permanent: true },
      { source: '/articles/university', destination: '/categories/university', permanent: true },
      { source: '/articles/vocational', destination: '/categories/vocational', permanent: true },
      { source: '/articles/interior', destination: '/categories/interior', permanent: true },
      { source: '/articles/realEstate', destination: '/categories/realEstate', permanent: true },
      { source: '/articles/autoEntrepreneur', destination: '/categories/autoEntrepreneur', permanent: true },
      { source: '/articles/hajj', destination: '/categories/hajj', permanent: true },
      { source: '/articles/commerce', destination: '/categories/commerce', permanent: true },
      { source: '/articles/customs', destination: '/categories/customs', permanent: true },
      { source: '/articles/vehicles', destination: '/categories/vehicles', permanent: true },
      { source: '/articles/transport', destination: '/categories/transport', permanent: true },
      { source: '/articles/health', destination: '/categories/health', permanent: true },
      { source: '/articles/socialSecurity', destination: '/categories/socialSecurity', permanent: true },
      { source: '/articles/publicContracts', destination: '/categories/publicContracts', permanent: true },
      { source: '/articles/enpi', destination: '/categories/enpi', permanent: true },
      { source: '/articles/aadl', destination: '/categories/aadl', permanent: true },
      { source: '/articles/retirement', destination: '/categories/retirement', permanent: true },
      { source: '/articles/foreignAffairs', destination: '/categories/foreignAffairs', permanent: true },
      ...
      { source: '/articles/raqmiya-musabaqa-natayij-mt64qa7b', destination: '/categories/mosbakat-toudif', permanent: true },
      ...
      { source: '/articles/jaysh-madaris-mt4x9d9a', destination: '/categories/mosbakat-toudif', permanent: true },
      ...
      { source: '/articles/trend-aldlyl-alshaml-lltjnyd-fy-mdars-wmwssat-aljysh-alw-mt4x9d9a', destination: '/categories/mosbakat-toudif', permanent: true },
      ...
      { source: '/articles/auto-aldlyl-alshaml-llatlaa-ala-alntayj-alnhayya-wastkm-mt64qa7b', destination: '/categories/mosbakat-toudif', permanent: true },
      ...
      { source: '/articles/auto-aldlyl-alshaml-llatlaa-ala-ntayj-msabqa-altwdhyf-a-mt6b0mck', destination: '/categories/mosbakat-toudif', permanent: true },
      ...
      // ✅ 301 Permanent Redirects for Jobs & Concours -> /categories/mosbakat-toudif
