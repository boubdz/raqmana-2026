...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ✅ 301 Redirects for renamed auto-generated article slugs (clean SEO slugs)
      { source: '/articles/trend-aldlyl-alshaml-lltjnyd-fy-mdars-wmwssat-aljysh-alw-mt4x9d9a', destination: '/articles/jaysh-madaris-mt4x9d9a', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lltsdyq-ala-alshhadat-wkshwf-alnqat-mt64ojuy', destination: '/articles/shahadat-mt64ojuy', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-l-almnsa-alrqmya-lwzara-altrbya-alw-mt64p71e', destination: '/articles/awliyaa-fadaa-tarbiya-mt64p71e', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-llatlaa-ala-alntayj-alnhayya-wastkm-mt64qa7b', destination: '/articles/raqmiya-musabaqa-natayij-mt64qa7b', permanent: true },
      { source: '/articles/trend-aldlyl-alshaml-ltqdym-shkawa-altnmya-almhlya-wmtab-mt69gkcy', destination: '/articles/tanmiya-mahaliya-shakawy-mt69gkcy', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lkhdmat-aldkhwl-almdrsy-abr-fdaa-al-mt6b1g5g', destination: '/articles/madrasi-dokhoul-awliyaa-mt6b1g5g', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lltrtybat-albydaghwjya-walkhdmat-al-mt6b2e3w', destination: '/articles/awliyaa-fadaa-raqmiya-mt6b2e3w', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lbrnamj-alshraka-walbhth-alalmy-wal-mt6p2ohk', destination: '/articles/shiraka-bahth-ilmi-mt6p2ohk', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lkhdmat-aliywaa-waliqamat-aljamaya--mt6p3bap', destination: '/articles/iiwaa-iqamat-jamiiya-mt6p3bap', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lmrafqa-wdam-alnkhb-aljamaya-walmsh-mt6v745e', destination: '/articles/jamiiya-ilmi-nukhab-mt6v745e', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lbrnamj-dam-wtkrym-almsharya-alabtk-mt6v7lxs', destination: '/articles/jamiiya-nukhab-ibtikaria-mt6v7lxs', permanent: true },
      // ✅ 301 Redirects for removed duplicate articles (redirecting to canonical remaining topic)
      { source: '/articles/auto-aldlyl-alshaml-lkhdma-altsdyq-ala-alshhadat-walwth-mt6p1zam', destination: '/articles/shahadat-mt64ojuy', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-l-mnsa-wzara-altrbya-alwtnya-wastkh-mt6ii8ij', destination: '/articles/awliyaa-fadaa-tarbiya-mt64p71e', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-llatlaa-ala-ntayj-msabqa-altwdhyf-a-mt6b0mck', destination: '/articles/raqmiya-musabaqa-natayij-mt64qa7b', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-l-rznama-aldkhwl-almdrsy-wajraaat-a-mt6ihjb6', destination: '/articles/madrasi-dokhoul-awliyaa-mt6b1g5g', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-l-mnsa-fdaa-alawlyaa-waltrtybat-alb-mt6iiy9m', destination: '/articles/awliyaa-fadaa-raqmiya-mt6b2e3w', permanent: true },
      { source: '/articles/auto-aldlyl-alshaml-lkhdmat-aliywaa-alitaam-walnql-alja-mt6v6n08', destination: '/articles/iiwaa-iqamat-jamiiya-mt6p3bap', permanent: true },
    ];
  },
